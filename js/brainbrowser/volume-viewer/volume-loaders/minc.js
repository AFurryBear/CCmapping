  ...
  VolumeViewer.createVolume = function(header, native_data) {
    ...
    var volume = {
      ...
      slice: function(axis, slice_num, time) {
        ...
        //console.log({tz_offset:tz_offset,tzy_offset:tzy_offset,tzyx_offset:tzyx_offset})
      ...
      getSliceImage: function(slice, zoom, contrast, brightness) {        
        ...
        //console.log({'minc.target.slice_width':target_width,'minc.target.slice_height':target_height});
        ...
        if (volume.header.datatype === 'rgb8') {
          ...
          color_map.mapVColors(slice.data, {
      ...
      getWorldCoords: function() {
        ...
        //console.log({xyz:volume.voxelToWorld(voxel.i, voxel.j, voxel.k)})
