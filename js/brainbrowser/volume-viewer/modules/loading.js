...
BrainBrowser.VolumeViewer.modules.loading = function(viewer) {
  ...
  * ```
  */
  viewer.loadDefaultColorMapFromFile = function(vol_id, file_input, cursor_color, callback) {
    BrainBrowser.loader.loadColorMapFromFile(file_input, function(color_map) {
      setDefaultColorMap(vol_id, color_map, cursor_color, callback);
    }, { scale: 255 });
  };
      ...
      views.forEach(function(axis_name) {
        ...
        canvas.addEventListener("mousedown", function(event) {
          ...
          if( event.ctrlKey||event.metaKey){
            ...
            viewer.active_panel.image_center={x:div_height*0.275,y:div_height*0.275};
            viewer.active_panel.zoom=viewer.active_panel.default_zoom;
