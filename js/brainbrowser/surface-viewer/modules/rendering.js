...
BrainBrowser.SurfaceViewer.modules.rendering = function(viewer) {
  ...
  var camera = new THREE.PerspectiveCamera(30, viewer.dom_element.clientWidth / viewer.dom_element.clientHeight, 1, 3000);
  ...
  */
  viewer.render = function() {
    ...
    renderer.setClearColor(0x9b9b9b);
  ...
  */
  viewer.updateViewport = function() {
    ...
    effect.setSize(dom_element.clientWidth, dom_element.clientHeight);
    camera.aspect = dom_element.clientWidth / dom_element.clientHeight;
  ...
  */
  viewer.addEffect = function(effect_name) {
    ...
    if (BrainBrowser.utils.isFunction(THREE[effect_name])) {
      ...
      effect.setSize(viewer.dom_element.clientWidth, viewer.dom_element.clientHeight);
  ...
  */
  viewer.pick = function(x, y, opacity_threshold) {
    ...
    x = (x / viewer.dom_element.clientWidth) * 2 - 1;
    y = (-y / viewer.dom_element.clientHeight) * 2 + 1;
