  ...
  */
  ...
  function createShape(object_description) {
    ...
    if (is_line) {
      ...
      material = new THREE.MeshPhongMaterial({color: 0xFFFFFF, ambient: 0xFFFFFF, specular: 0x101010, shininess: 10, vertexColors: THREE.VertexColors});
