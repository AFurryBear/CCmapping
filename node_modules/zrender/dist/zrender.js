...
Animator.prototype = {
    ...
    start: function (easing, forceAnimate) {
        ...
        // the views may be refreshed frequently, where animation will be
...
var localDOMHandlers = {
    ...
    touchend: function (event) {
        ...
        // style" will remain for user views)
...
function mountLocalDOMEventListeners(instance, scope) {
    ...
    if (env$1.pointerEventsSupported) { // Only IE11+/Edge
        ...
        // which does not prevent defuault behavior occasionally (which may cause views port
